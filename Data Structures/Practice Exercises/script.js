...
document.querySelector("button").addEventListener("click", function () {
  ...
  if (text.includes("\n")) {
    ...
    for (const [i, temp] of newText2.entries()) {
      if (temp.includes("_")) {
        let [first, second] = temp.split("_");
        ...
        newString = newString.padEnd(25, " ");
        // for (let k = 0; k <= i; k++) newString = newString + "✅";

        // Other way to get same output
        newString = newString + "✅".repeat(i + 1);
